...
| `integrations/os-automation/` | keyboard shortcut adapter (issue #10) and application/file/URL launch adapters (issue #11): Windows real backends, honest Unsupported elsewhere |
