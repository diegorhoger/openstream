...
Read the [PRD](docs/product/PRD.md), [roadmap](docs/product/ROADMAP.md), [technical specification](docs/architecture/TECHNICAL_SPEC.md), [domain model](docs/architecture/DOMAIN_MODEL.md), [OSCP message contract](docs/architecture/OSCP_MESSAGES.md), [security model](docs/architecture/SECURITY.md), [design tokens](docs/design/DESIGN_TOKENS.md), [workspace and build](docs/architecture/WORKSPACE.md), [threat model and capability taxonomy](docs/security/README.md), and [agent graph](docs/engineering/AGENT_GRAPH.md).
